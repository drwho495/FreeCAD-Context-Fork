...
void ConstraintView::swapNamedOfSelectedItems()
{
    ...
    std::string escapedstr1 = Base::Tools::escapedEncodeString(
        item1->sketch->Constraints[item1->ConstraintNbr]->Name);
    ConstraintItem* item2 = static_cast<ConstraintItem*>(items[1]);
    std::string escapedstr2 = Base::Tools::escapeEncodeString(
        item2->sketch->Constraints[item2->ConstraintNbr]->Name);
