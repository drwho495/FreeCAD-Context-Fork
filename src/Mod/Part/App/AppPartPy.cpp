...
private:
    ...
    Py::Object makeWires(const Py::Tuple& args, const Py::Dict &kwds)
    {
        ...
        double tol = 1e-7;
        static std::array<char*,6> kwd_list = {"shapes", "op", "tol", "keep_order", "shared", nullptr};
    ...
    Py::Object makeBSplineFace(const Py::Tuple& args, const Py::Dict &kwds)
    {
        ...
        const char *op=nullptr;
        static std::array<char*,5> kwd_list = {"shapes", "style", "keepBezier",  "op", nullptr};
    ...
    Py::Object makeFilledFace(const Py::Tuple& args, const Py::Dict &kwds)
    {
        ...
        const char *op = nullptr;
        static std::array<char*,16> kwd_list = {"shapes", "surface", "supports", 
    ...
    Py::Object importExternalObject(const Py::Tuple& args, const Py::Dict &kwds) {
        ...
        static std::array<char*, 6> kwd_list = {"obj", "editObj", "wholeObject", "noSubObject", "noSubElement", nullptr};
    ...
    Py::Object joinWires(const Py::Tuple& args, const Py::Dict &kwds) {
        ...
        double tol = 1e-6;
        const char *op = "";
        static std::array<char*,10> kwd_list = {"shape", "split", "merge", "tighten", "outline", "keep_open", "no_open_original", "tol", "op", nullptr};
