    ...
    , cells(this)
{
    ...
    ADD_PROPERTY_TYPE(rowHeights,
                      ...
                      (PropertyType)(Prop_ReadOnly | Prop_Hidden | Prop_Output),
                      "Row heights");
    ADD_PROPERTY_TYPE(hiddenRows,
                      (),
                      "Spreadsheet",
                      (PropertyType)(Prop_Hidden | Prop_Output),
                      "Hidden rows");
    ADD_PROPERTY_TYPE(hiddenColumns,
                      (),
                      "Spreadsheet",
                      (PropertyType)(Prop_Hidden | Prop_Output),
                      "Hidden columns");
    ADD_PROPERTY_TYPE(PythonMode,
                      (false),
                      "Spreadsheet",
                      Prop_None,
                      "Set default expression syntax mode");
    ADD_PROPERTY_TYPE(ShowCells,
                      ((long)ShowCellEnum::None),
                      "Spreadsheet",
                      Prop_None,
