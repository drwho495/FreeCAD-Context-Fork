...
void CmdTechDrawView::activated(int iMsg)
{
    ...
    Gui::cmdAppObject(docObj, "translateLabel('DrawViewPart', 'View', '%s')", FeatName);
...
void CmdTechDrawSymbol::activated(int iMsg)
{
    ...
    if (!filename.isEmpty())
    {
        ...
        Gui::cmdAppObject(feat, "translateLabel('DrawViewSymbol', 'Symbol', '%s'), FeatName);
...
void CmdTechDrawDraftView::activated(int iMsg)
{
    ...
    for (std::vector<App::DocumentObject*>::iterator it = objects.begin(); it != objects.end(); ++it) {
        ...
        auto feat = page->getDocument()->getObject(FeatName.c_str());
        Gui::cmdAppObject(feat, "translateLabel('DrawViewDraft', 'DraftView', '%s'), FeatName);
...
void CmdTechDrawArchView::activated(int iMsg)
{
    ...
    auto feat = page->getDocument()->getObject(FeatName.c_str());
    Gui::cmdAppObject(feat, "translateLabel('DrawViewArch', 'ArchView', '%s')", FeatName);
...
void CmdTechDrawSpreadsheetView::activated(int iMsg)
{
    ...
    auto feat = page->getDocument()->getObject(FeatName.c_str());
    Gui::cmdAppObject(feat, "translateLabel('DrawViewSpreadsheet', 'Sheet', '%s')", FeatName);
