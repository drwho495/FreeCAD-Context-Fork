...
void DlgSettingsSelection::saveSettings()
{
    ...
    ui->checkBoxPreSelectionOnTop->onSave();
    ui->checkBoxShowBoundBox->onSave();
    ui->checkBoxHiddenLineSelect->onSave();
    ui->checkBoxSelectElementOnTop->onSave();

    ui->comboBoxToolTipCorner->onSave();
    ui->spinBoxToolTipOffsetX->onSave();
    ui->spinBoxToolTipOffsetY->onSave();
    ui->spinBoxToolTipFontSize->onSave();
    
    ui->spinBoxColorDiff->onSave();
    ui->spinBoxSelectionBBoxThreshold->onSave();
...

{
    ...
    ui->comboBoxToolTipCorner->onRestore()
    ui->spinBoxToolTipOffsetX->onRestore();
    ui->spinBoxToolTipOffsetY->onRestore();
    ui->spinBoxToolTipFontSize->onRestore();

    ui->spinBoxColorDiff->onRestore();
    ui->spinBoxSelectionBBoxThreshold->onRestore();
